         ...
         <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row space-x-3 text-sm">
               <button className="py-2 hover:border-blue-500 hover:bg-blue-400/10 basis-1/2 flex flex-row justify-center items-center space-x-2 rounded-xl border border-gray-700">
                  <img src="/img/logo/brands/google.svg" className="w-[15px] h-auto"/>
                  <p>Google</p>
               </button>
               <button className="py-2 hover:border-blue-500 hover:bg-blue-400/10 basis-1/2 flex flex-row justify-center items-center space-x-2 rounded-xl border border-gray-700">
                  <img src="/img/logo/brands/facebook.svg" className="w-[20px] h-auto"/>
                  <p>Facebook</p>
               </button>
            </div>
         </div>
         <p className="text-center text-sm">Don't have an account yet? <a href="/register" className="text-sky-500 hover:underline cursor-pointer">Register</a></p>
      </form>
   );
}
