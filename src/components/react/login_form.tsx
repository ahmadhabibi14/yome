         ...
         <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row items-center w-full relative">
               ...
               <button title={!showPass? 'Show Password' : 'Hide password'} className="absolute right-0 top-0 p-3 h-full" onClick={() => setShowPass(!showPass)} >
                  ...
                  <svg className={showPass ? 'fill-gray-600 hover:fill-sky-500 w-[24px] h-auto block' : 'fill-gray-600 hover:fill-sky-500 w-[24px] h-auto hidden'}>
            ...
            <button type="submit" className="text-lg font-semibold py-2 rounded-xl bg-blue-600 text-gray-50 hover:bg-blue-500">
               Login
            </button>
         </div>
         <p className="text-sm text-center">Forgot Password? <a className="text-sky-500 hover:underline cursor-pointer" href="/reset-password">Reset here</a></p>
         <a className="cursor-pointer text-center text-lg font-semibold py-2 rounded-xl bg-emerald-600 text-gray-50 hover:bg-emerald-500">Create new account</a>
      </form>
   )
}
