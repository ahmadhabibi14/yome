      ...
      <nav className="navbar">
         ...
         <div className="flex flex-row space-x-4">
            ...
            <button className="group">
               <span className="absolute w-10 h-10 group-hover:block hidden bg-sky-400/20 rounded-full -ml-1.5 -mt-1.5"></span>
               <svg className="group-hover:scale-90 duration-100 relative w-[29px] h-auto stroke-current group-hover:stroke-sky-700" viewBox="0 0 24 24">
